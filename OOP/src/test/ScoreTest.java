...
public class ScoreTest {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 10; ++i) {
            ...
            String randomUUID = UUID.randomUUID().toString().replaceAll("-", "").substring(0, 10);
            ...
            try {
                ...
                if (score < 0 || score > 100) {
                    score = 0;
                    throw new ScoreException("Invalid Score. Using default 0 value."); // Throw the exception and set
                                                                                       // value to 0
                }
            }
